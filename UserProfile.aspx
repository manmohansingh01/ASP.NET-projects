                 ...
                 <div class="card">
                     <div class="card-body">
                         ...
                         <div class="row">
                                      ...
                                      <div class="col">
                                          <center>
                                 <span class="badge badge-pill badge-info">Change Password</span>
                                   </center>
                                 </div>
                         </div>
                          <div class="row">
                             ...
                             <div class="col-md-4">
                                 ...
                                 <div class="form-group">
                                     <asp:TextBox class="form-control" ID="TextBox11" runat="server" placeholder="old Password" TextMode="Password" ReadOnly="True"></asp:TextBox>
                             </div>
                             </div>
                              <div class="col-md-4">
            ...
            <div class="col-md-7">
                <div class="card">
                     <div class="card-body">
                         ...
                         <div class="row">
                             <div class="col">
                                 <asp:GridView class="table table-dark table-bordered" ID="GridView1" runat="server"></asp:GridView>
                             </div>
                         </div>
